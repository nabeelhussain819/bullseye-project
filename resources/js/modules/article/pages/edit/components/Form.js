...
const Form = ({ article, errors, onChange, onSubmit }) => {
  ...
  return <form onSubmit={e => onSubmit(e)}>
    <div className="form-group row">
      <label htmlFor="title" className="col-sm-2 col-form-label">Update Survey Status: </label>
    ...
    <div className="form-group row">
      <label htmlFor="description" className="col-sm-2 col-form-label">Survey Description</label>
      <div className="col-sm-10">
